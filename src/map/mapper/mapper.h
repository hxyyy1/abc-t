...
extern void            Map_ManSetFileName( Map_Man_t * p, char * pFileName );
...
extern void            Map_ManSetMctsEnable( Map_Man_t * p, int fEnable );
extern void            Map_ManSetMctsEarly( Map_Man_t * p, int fEnable );
extern void            Map_ManSetMctsLate( Map_Man_t * p, int fEnable );
extern void            Map_ManSetMctsParallel( Map_Man_t * p, int fEnable );
extern void            Map_ManSetMctsSimNum( Map_Man_t * p, int nSims );
extern void            Map_ManSetMctsRegionNum( Map_Man_t * p, int nRegions );
extern void            Map_ManSetMctsRegionMax( Map_Man_t * p, int nRegionMax );
